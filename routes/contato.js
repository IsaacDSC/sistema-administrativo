...
if(!req.body.nome || typeof req.body.nome == undefined || req.body.nome == null){
    errors.push({ error: "Necesário preencher o campo nome!"})
}
if(!req.body.email || typeof req.body.email == undefined || req.body.email == null){
    errors.push({ error: "Necesário preencher o campo E-mail!"})
}
if(!req.body.assunto || typeof req.body.assunto == undefined || req.body.assunto == null){
    errors.push({ error: "Necesário preencher o campo Assunto!"})
}
if(!req.body.mensagem || typeof req.body.mensagem == undefined || req.body.mensagem == null){
    errors.push({ error: "Necesário preencher o campo Mensagem!"})
}
if(errors.length > 0){
    res.redirect('/contato', {errors: errors})
}else{
    const add_contato = {
        nome: req.body.nome,
    ...
    new AddContato(add_contato).save().then(()=>{
       ...
       res.redirect('/contato')
        ...
        res.send('Erro ao enviar o formulário! ' + err)
    })
}
